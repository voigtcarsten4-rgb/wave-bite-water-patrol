  ...
  var News = {
    ...
    showBriefing: function (rec) {
      ...
      if (!locId) { // allgemeine Tagesnews: rotierende Immersion-Kulisse
        var amb = ['im_marina_wannsee','im_steg_mueggelsee','im_sup_spree','im_hausboot_havel','im_wasserrestaurant_rummelsburg','im_ankerplatz_werder','im_marina_potsdam','im_regattastrecke_gruenau','im_camping_wasser','im_bootshaus_verein','im_wasserwanderer_rast','im_fahrgastschiff_anleger','im_strandbad_wannsee','im_spreewaldkahn','im_strandbar_wasser','im_seebruecke_promenade'];
