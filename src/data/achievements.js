...
(function (WB) {
  ...
  WB.data.achievements = [
    A({ id: 'first_delivery', name: 'Erster Einsatz', desc: 'Schließe deinen ersten Einsatz ab.', icon: '⚓', goal: 1, stat: 'deliveries' }),
    A({ id: 'ten_deliveries', name: 'Erfahrene Crew', desc: 'Schließe 10 Einsätze ab.', icon: '🚔', goal: 10, stat: 'deliveries' }),
    A({ id: 'perfect_run', name: 'Saubere Fahrt', desc: 'Beende einen Einsatz mit 3 Sternen.', icon: '🌟', goal: 1, stat: 'perfectRuns' }),
    A({ id: 'rich_captain', name: 'Gut ausgerüstet', desc: 'Verdiene insgesamt 2.000 Coins.', icon: '🪙', goal: 2000, stat: 'coinsEarned' }),
    A({ id: 'level_five', name: 'Befoerdert', desc: 'Erreiche Captain-Level 5.', icon: '🎖', goal: 5, stat: 'captainLevel' })
  ];

  WB.data.dailyTasks = [
    D({ id: 'd_runs3', name: 'Drei Einsätze heute', goal: 3, stat: 'runs', rewardCoins: 120, rewardXp: 80 }),
    D({ id: 'd_deliver2', name: 'Zwei saubere Einsätze', goal: 2, stat: 'deliveries', rewardCoins: 140, rewardXp: 90 })
  ];

  WB.data.weeklyChallenges = [
    W({ id: 'w_deliver15', name: 'Wocheneinsatz: 15 Einsätze', goal: 15, stat: 'deliveries', rewardCoins: 600, rewardXp: 400 }),
